...
void TIM1_Int_Init(u16 arr,u16 psc)
{
  TIM_TimeBaseInitTypeDef  TIM_TimeBaseStructure;
	...
	TIM_ITConfig(TIM1,TIM_IT_Update/*|TIM_IT_Trigger*/,ENABLE ); //使能指定的TIM3中断,允许更新中断

	NVIC_InitStructure.NVIC_IRQChannel = TIM1_UP_IRQn;  //TIM1向上计数中断
...
{  
   ...
   //设置该引脚为复用输出功能,输出TIM3 CH1的PWM脉冲波形	GPIOA.6
	...
	GPIO_Init(GPIOA, &GPIO_InitStructure);//初始化GPIO
	 ...
	 //设置该引脚为复用输出功能,输出TIM3 CH1的PWM脉冲波形	GPIOA.7
